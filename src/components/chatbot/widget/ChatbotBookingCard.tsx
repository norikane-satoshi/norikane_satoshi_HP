                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        selected
                          ? "border-[var(--accent-primary)] bg-[var(--accent-primary)] text-white ring-2 ring-[var(--accent-primary)] ring-offset-1 ring-offset-white/60"
                          : "border-white/45 bg-white/30 text-hp-muted opacity-60",
                      ].join(" ")}
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      selected
                        ? "border-[var(--accent-primary)] bg-[var(--accent-primary)] font-bold text-white ring-2 ring-[var(--accent-primary)] ring-offset-1 ring-offset-white/60"
